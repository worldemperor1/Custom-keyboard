...
* I got stuck on the net labels and had to redo the circuits a few times. I didn't know how labels worked and thought I had to place one at each pin so it will automatically connect them all.

![Labels](./svgs/1/Labels.png)
...
* I added the footprints and placed the switches and the microcontroller on the PCB. 

![My Keyboard PCB](./svgs/2/PCB.png)

* I removed the extra switch and RGB I had. 

* I changed the capacitors to bigger ones, so instead of 0603 I am now using 0805.
...
* My new routing is still problematic because the RGB GPIO pin on my Rasberry Pi is blocked by surrounding traces.
